...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct  9 14:29:27 2021
...
class Canguro:
    def __init__(self,n,l = []):
        self.nombre = n
        self.contenido_marsupio = l
    def meter_en_marsupio(self,o):
        self.contenido_marsupio.append(o)
    def __str__(self):
        return f'Canguro {self.nombre} tiene en su marsupio {self.contenido_marsupio}'
    def __repr__(self):
